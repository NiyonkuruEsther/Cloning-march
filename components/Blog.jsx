...
const Blog = () => {
  ...
  return (
    <div className="w-screen px-2 bg-[#E6E6E6] pt-16">
      ...
      <div
        ref={blogSect}
        className="flex gap-4 ease-in-out duration-500 max-w-full overflow-x-hidden"
      >
        {BLOGS.map((item, i) => {
          return (
            <div
              key={i}
              className="w-[247px] md:w-[434px] hover:shadow-medium hover:cursor-pointer duration-500 group h-[460px] mb-10 min-[470px]:w-[60%] sm:w-[45%] lg:w-[26%] flex-shrink-0 mr-4 rounded-[4px] border border-[#E6E6E6] bg-white"
            >
              <div className="">
                <img src={item.src} alt="" className="h-[143px] w-full" />
              </div>
