...
export default function Grid() {
  return (
    <Wrapper>
      <div className="pt-24 sm:w-[64.66667%] justify-between lg:w-auto lg:max-w-[1141.6px] mx-auto flex flex-col lg:flex-row relative lg:pt-52 sm:pt-[72px] sm:pb-[86px] -mb-8 sm:-mb-20 md:mb-32 lg:mb-20">
        ...
        <div className="  gap-6 relative">
          ...
          <img
            ...
            alt=""
            className="object-cover object-center lg:max-w-xl"
          />
        </div>
